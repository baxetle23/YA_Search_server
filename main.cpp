...
//     const auto dictionary = GenerateDictionary(generator, 500, 10);
//     const auto documents = GenerateQueries(generator, dictionary, 5000, 70);

//     const string query = GenerateQuery(generator, dictionary, 250, 0.1);
